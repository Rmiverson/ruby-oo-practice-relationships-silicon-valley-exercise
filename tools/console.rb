...
# so they will be available to test and play around with in your console
  ...
  r1 = FundingRound.new("3FO", venture1, "pre-seed")
  r2 = FundingRound.new("valve", venture2, "series c")
  r3 = FundingRound.new("google", venture3, "pre-seed")
  r4 = FundingRound.new("bing", venture4, "pre-seed")
